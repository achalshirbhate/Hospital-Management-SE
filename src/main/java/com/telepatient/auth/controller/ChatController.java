...
public class ChatController {
    ...
    public ResponseEntity<ChatSyncResponseDTO> getChatHistory(@PathVariable Long tokenId) {
        ...
        List<ChatMessageDTO> messages = chatRepo.findByTokenPatientOrderBySentAtAsc(token.getPatient()).stream()
        ...
        boolean isTerminated = token.getStatus() == TokenStatus.COMPLETED;
